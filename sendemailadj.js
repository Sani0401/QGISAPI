...
async function sendEmailadj(saltKey, district,village, lgd_code, khasra_no) {
  ...
  const mailOptions = {
    ...
    text: `
      ...
      This email includes the following variables from adjData : API:
